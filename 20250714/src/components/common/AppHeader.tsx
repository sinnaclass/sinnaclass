...
function AppHeader() {
  return (
    <div className="w-full flex items-center justify-between px-10 py-[30px] bg-[#121212]">
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-8">
          ...
          <Separator orientation="vertical" className="!h-4 text-neutral-200" />
